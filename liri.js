// Node module imports needed to run the functions
	...
	function myTweets() {
		var client = new twitter({
		  consumer_key: 'cngkdrnKC611hrBqW5pYVnIf4',
		  consumer_secret: '5W4Q3OJmU8wXFAoR3LiIYv9BKCsTXTbGqSkx41iYsIDIqSJY7C',
		  access_token_key: '960310948748845062-v8hdaWCYyJ8uKf47pvPikPVZ57OwJMb',
		  access_token_secret: '5MNdMvZN3xKFxXv3pcCsIj5qhVcP2IRIUfjqvE1faiGFO'
		});
		...
		if(!twitterUsername){
			twitterUsername = "Lamaj Reltub";
		}
		client.get('statuses/user_timeline', params, function(error, tweets, response) {
		  if (!error) {

		  	var divider = " ================= LIRI GOT YOU " + twitterUsername.toUpperCase() +  "LAST 20 TWEETS...================\n\n";
		  	console.log(divider);
